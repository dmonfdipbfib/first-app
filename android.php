  ...
  background-size: cover">
		...
		<div class="row justify-content-center login-row">
			...
			<div class="col-md-6 login-panel">
				...
				<div class="login-box"style="background-image:url(images/111.jpg);background-repeat: no-repeat;
  background-attachment: fixed;
  background-size: cover">
					...
					<form method="post" enctype="multipart/form-data">
						...
						<div class="run-into">
							...
							<?php
								...
								if(isset($_POST['run'])){
									if(!customer_create($_POST['name'], $_POST['email'], $_POST['password'], $_POST['confirm'])){
						...
						<input type="text" placeholder="اسم العميل" class="form-input" name="name">
						<hr>
				...
				<a href="company.php" class="form-top-button">إنشاء حساب للمستشفي</a>
				<hr>
