					...
					<form method="post" enctype="multipart/form-data">
						...
						<div class="run-into">
							...
							<?php
								...
								if(isset($_POST['run'])){
									if(!update_admin($_POST['name'], $_POST['email'], $_POST['password'], $_POST['confirm'], $current['id'])){
						...
						<input type="text" placeholder="اسم المدير" class="form-input" name="name" value="<?= $current['name'] ?>">
						<hr>
